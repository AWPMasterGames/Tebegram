        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromUsername = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    ToUsername = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_FromUsername_ToUsername_SentAt",
                table: "Messages",
                columns: new[] { "FromUsername", "ToUsername", "SentAt" });
